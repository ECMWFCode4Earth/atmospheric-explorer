...
class CAMSParameters(Parameters):
    ...
    def __init__(self, data_variables: str | set[str] | list[str]) -> None:
        """Initializes an instance of CAMSParameters.

        Attributes:
            data_variables (str | set[str] | list[str]): data varaibles to be downloaded from CAMS,
    ...
    def subset(self: CAMSParameters, other: CAMSParameters):
        ...
        Attributes:
            other (CAMSParameters): the other instance of CAMSParameters to be compared with self
        """
