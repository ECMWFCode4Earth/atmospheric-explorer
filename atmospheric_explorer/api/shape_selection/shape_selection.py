...
class Selection:
    ...
    def __init__(
        ...
        """Initializes Selection instance."""
    ...
    def __repr__(self) -> str:
        """Printable representation of Selection instance."""
        return repr(self.dataframe)

    def __eq__(self, other: Selection) -> bool:
        """Allows == operator between Selection instances."""
        if not self.empty():
            try:
...
class GenericShapeSelection(Selection):
    ...
    def __init__(self, dataframe: gpd.GeoDataFrame | None = None):
        """Initializes GenericShapeSelection instance."""
...
class EntitySelection(Selection):
    ...
    def __init__(
        ...
        """Initializes EntitySelection instance."""
    ...
    def from_generic_selection(
        ...
        """Generates an EntitySelection object encompassing entitities that \
        are touched by the generic_shape_selection objects passed.
    ...
    def from_entities_list(
        ...
        """Generates an EntitySelection object from a list of entities, shapes are taken from the shapefile."""
        if entities:
    ...
    def from_entity_selection(
        ...
        """Converts an EntitySelection object to a new SelectionLevel."""
...
def from_out_event(out_event, level: SelectionLevel) -> Selection:
    """Generates a GenericShapeSelection/EntitySelection object from an output event generated by streamlit_folium."""
