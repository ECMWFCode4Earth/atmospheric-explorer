...
class Selection(ABC):
    ...
    @classmethod
    @abstractmethod
    def from_out_event(cls, out_event):
...
class GenericShapeSelection(Selection):
    ...
    @classmethod
    def from_out_event(cls, out_event) -> GenericShapeSelection:
        """Generate a GenericShapeSelection object from an output event generated by streamlit_folium."""
...
class EntitySelection(Selection):
    ...
    @classmethod
    def from_out_event(cls, out_event) -> EntitySelection:
        """Generate an EntitySelection object from an output event generated by streamlit_folium."""
        admin = cls.get_event_label(out_event)
        if admin is None:
