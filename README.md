...
This section will briefly go over some main concepts, for more in depth use we refer the reader to the API documentation as described in the [API Documentation](#api-documentation) section.
...
The documentation is automatically generated from docstrings using [Sphinx](https://www.sphinx-doc.org/en/master/) and two of its extensions: [autodoc](https://www.sphinx-doc.org/en/master/usage/extensions/autodoc.html) and [napoleon](https://www.sphinx-doc.org/en/master/usage/extensions/napoleon.html).
